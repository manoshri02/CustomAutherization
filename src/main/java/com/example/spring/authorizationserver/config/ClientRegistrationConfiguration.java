...
public class ClientRegistrationConfiguration {
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate, PasswordEncoder passwordEncoder) {
        ...
        JdbcRegisteredClientRepository registeredClientRepository = null;
        try {
            ...
            RegisteredClient demoClientPkce = RegisteredClient.withId(UUID.randomUUID().toString())
                    ...
                    .tokenSettings(TokenSettings.builder().accessTokenFormat(OAuth2TokenFormat.SELF_CONTAINED)
                            .accessTokenTimeToLive(Duration.ofMinutes(15))
                            .authorizationCodeTimeToLive(Duration.ofMinutes(10)).build())
                    .redirectUris(uris -> {
                        uris.addAll(redirectUris);
                    })
                    .scopes(scopes -> scopes.addAll(List.of(
            ...
            registeredClientRepository = new JdbcRegisteredClientRepository(jdbcTemplate);
            //registeredClientRepository.g
            ...
            LOGGER.info("Duplicate client exist.");
