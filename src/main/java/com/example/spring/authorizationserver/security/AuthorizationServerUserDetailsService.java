...
import com.example.spring.authorizationserver.repo.UserRepo;
...
public class AuthorizationServerUserDetailsService implements UserDetailsService {
    ...
    public AuthorizationServerUserDetailsService(PasswordEncoder passwordEncoder, UserRepo userRepo) {
